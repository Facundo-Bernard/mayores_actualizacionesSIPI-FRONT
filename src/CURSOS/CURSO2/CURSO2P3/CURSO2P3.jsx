...
const preguntas = [
  {
    ...
    pregunta: "¿Para qué sirven los botones + y - en un teléfono móvil?", // Texto de la pregunta
  ...
  },
  {
    ...
    pregunta: "¿Cuál es la función de la tienda de aplicaciones en un dispositivo móvil?",
    opciones: [
      "Instalar y eliminar archivos personales",
      "Descargar e instalar nuevas aplicaciones",
  ...
  {
    tipo: 'Multiple-choice',
    pregunta: "¿Qué se debe hacer para alternar entre aplicaciones abiertas en su dispositivo?",
    opciones: [
      "Deslizar hacia arriba desde la parte inferior de la pantalla y mantener presionado",
      "Presionar el botón de encendido repetidamente",
      "Deslizar el dedo desde la esquina superior derecha",
      "Ninguna de las anteriores",
    ],
    respuestaCorrecta: 0
  },
  {
    ...
    pregunta: "El ícono de un teléfono verde en el dispositivo permite hacer llamadas. (V/F)",
    respuestaCorrecta: true // Respuesta correcta (true para Verdadero)
  },
  {
    tipo: 'true-false', // Tipo de pregunta (verdadero o falso)
    pregunta: "¿Se puede eliminar una aplicación desde el menú principal del celular manteniendo presionado sobre el ícono y seleccionando Eliminar/Desinstalar? (V/F)",
    respuestaCorrecta: true // Respuesta correcta (true para Verdadero)
  },
  {
    tipo: 'open-ended', // Tipo de pregunta de respuesta abierta
    pregunta: "¿Qué pasos debe seguir para grabar la pantalla de su dispositivo móvil?",
    respuestaCorrecta: "Para grabar la pantalla en un dispositivo Android, deslice desde la parte superior de la pantalla para abrir el menú de accesos rápidos y seleccione el ícono de 'Grabar pantalla'. La grabación comenzará después de una cuenta regresiva. Para detenerla, toque el ícono de nuevo y el video se guardará en la galería. En iOS, deslice desde la esquina superior derecha para abrir el Centro de Control, toque el ícono de grabación de pantalla y, para detenerla, toque la barra roja en la parte superior y seleccione 'Detener'."
  }
];

// Define el componente principal del examen
function ExamenFinal2() {
  ...
  const enviarRespuestas = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:8080/progreso/actualizar/${user.id}/2`, {
  ...
  return (
    <div className="examen-final-container animate__animated animate__fadeIn">
      <h1 className="text-center my-4">Evaluación de conocimientos sobre el uso basico del celular</h1> {/* Título del examen */}
