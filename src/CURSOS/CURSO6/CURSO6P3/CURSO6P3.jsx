...
const preguntas = [
  {
    ...
    pregunta: "¿Qué función principal tiene una billetera virtual?", // Texto de la pregunta
    opciones: [ // Opciones de respuesta
      "Guardar efectivo en la casa.",
      "Almacenar dinero digitalmente para realizar pagos y transferencias.",
      "Ofrecer descuentos en tiendas físicas.",
  ...
  },
  {
    ...
    pregunta: "¿Qué debe hacer antes de confirmar un pago con código QR en una tienda física?",
    opciones: [
      "Escanear el código y cerrar la aplicación.",
      "Verificar el monto de la transacción.",
      "Llamar al vendedor para confirmar el pago.",
      "Ninguna de las anteriores"
    ],
    respuestaCorrecta: 1
  },
  {
    tipo: 'Multiple-choice',
    pregunta: "¿Qué información necesita para realizar una transferencia desde una billetera virtual?",
    opciones: [
      "El número de identificación del destinatario.",
      "El número de cuenta o el número de teléfono del destinatario.",
      "Una contraseña específica para cada transferencia.",
      "Ninguna de las anteriores"
    ],
    respuestaCorrecta: 1
  },
  {
    ...
    pregunta: "Las billeteras virtuales permiten programar pagos automáticos para servicios recurrentes. (V/F)",
    respuestaCorrecta: true // Respuesta correcta (true para Verdadero)
  }, 
  {
    tipo: 'true-false', // Tipo de pregunta (verdadero o falso)
    pregunta: "Al usar una billetera virtual, no es necesario verificar los datos del destinatario antes de realizar una transferencia. (V/F)",
    respuestaCorrecta: false // Respuesta correcta (true para Verdadero)
  },
  {
    tipo: 'open-ended', // Tipo de pregunta de respuesta abierta
    pregunta: "¿Cómo se realiza un pago en una tienda física utilizando un código QR?",
    respuestaCorrecta: "Para realizar un pago con código QR, primero se abre la aplicación de billetera virtual y se selecciona la opción de pago con código QR. Luego, se escanea el código QR proporcionado por el vendedor, se verifica el monto de la transacción, y finalmente se confirma el pago."
  }
];

// Define el componente principal del examen
function ExamenFinal6() {
  ...
  const enviarRespuestas = async () => {
    ...
    try {
      ...
      console.error("Error en enviar Respuestas:", error); // Muestra error si hay problemas de conexión
    }
  };
  ...
  return (
    <div className="examen-final-container animate__animated animate__fadeIn">
      <h1 className="text-center my-4">Evaluación de conocimientos sobre billeteras virtuales y compras en línea</h1> {/* Título del examen */}
